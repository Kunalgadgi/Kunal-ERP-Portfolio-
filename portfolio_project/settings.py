...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-f4yb56!l4!8dze(9mfh8=zz-4xx(6zxlv$+9qfd!+l#for_mcy'
)
...
# Media files (user uploads: profile photo, resume, project images, etc.)
MEDIA_URL = '/media/'
...
# For development, messages print to the console.
